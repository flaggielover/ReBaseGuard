...
P4ZA = f"{REL}/p4za_fullscope_closure"
...
TCB_PATHS = (
    ...
    # P4ZA's own producer and frozen plan
    f"{P4ZA}/production/run_p4za.py",
    f"{P4ZA}/production/p4za_hash.py",
    f"{P4ZA}/production/p4za_campaign_plan.json",
)
...
def build_manifest() -> dict:
    ...
    m = {"schema":"rebaseguard.p4za-producer-manifest.v1","entries":entries}
