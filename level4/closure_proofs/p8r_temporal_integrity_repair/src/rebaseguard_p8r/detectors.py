...
P8R provenance: byte-for-byte the P8 module `.../rebaseguard_p8/detectors.py` apart from this note.  Both recurrences are inherited frozen and were not implicated in the P8 failure.
"""
