...
|---|---|---|---|
| C1 | Arb interval proves `Gamma_SR>2` at exact runtime rational for authoritative `A` | non-blocking rigor upgrade | NOT STARTED |
| C2 | independent certificate auditor reconstructs all critical claims | required only for `SR-GAMMA-CERTIFIED` | NOT STARTED |
