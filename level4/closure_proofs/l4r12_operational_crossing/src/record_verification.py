#!/usr/bin/env python3
"""Record the authoritative verifier result without mutable timestamps."""
...
def main() -> int:
    ...
    counts = [int(value) for value in re.findall(r"(?:^|\s)(\d+) passed(?:[,\s]|$)", proc.stdout)]
    result = {
        "schema": "rebaseguard.l4r12-verification.v1",
        ...
        "pytest_pass_count": sum(counts),
        "pytest_suite_pass_counts": counts,
