    ...
    for m in TC.MS:
        ...
        for i, r in enumerate(rows):
            ...
            if r["pass"] and r["via"] == "L1":
                ...
                row = {"cell": i, "verdict": "PASS", "route": "K5-B chain U_k < 0 with the T-EXT channel",
                       "evidence": "T-EXT TEXT_RESULT (sealed) + K1 record", "artifact_sha256": TEXT_SHA256,
                       "k1_record_sha256": rec_sha}
            elif r["pass"]:
