...
def main() -> int:
    ...
    # ledger_ops.py and supervisor.py are GENERATED (GRACEFUL_DRAIN; marker reconciliation)
    # ledger_ops.py, supervisor.py, produce_entry.py are GENERATED
    for name in ("opscommon.py", "locks.py", "runtime_state.py"):
