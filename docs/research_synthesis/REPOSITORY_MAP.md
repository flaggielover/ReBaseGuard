...
| What is proved for SR? | `level4/closure_proofs/sr_derivative/FINAL_REPORT.md` | `level4/closure_proofs/sr_derivative/THEOREM.md`; `level4/closure_proofs/sr_derivative/lean/SRDerivative.lean`; `level4/closure_proofs/sr_derivative/ARBITRARY_PRECISION_ATTEMPT.md` |
